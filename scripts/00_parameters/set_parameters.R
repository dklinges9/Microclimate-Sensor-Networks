...
# variables 
spatial_extent <- c(47.4, 47.55, -21.6, -21.45) # c(5042788.27696657, 5064493.44436001, 1817708.23946404, 1850265.99055419) # c(-83.8, -83.3, 35.3, 35.8) # c(748472.066251046, 764572.066251046, -2389957.46406275, -2373857.46406275) # c(47.4, 47.55, -21.6, -21.45) # provide also in meters 
...
projection <- "+proj=longlat +datum=WGS84"  # "+proj=robin +lon_0=0 +x_0=0 +y_0=0 +ellps=WGS84 +datum=WGS84 +units=m +no_defs" # "+proj=longlat +datum=WGS84" 
projection_units <- "dd" # c("m", "dd")
...
# desired r2. 
# Used for calculating f2 (effect size) in power analysis. If unknown, kept at 0.1
